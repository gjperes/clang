...
/**
 * @brief Cria uma nova lista e aloca ela em memória
...
/**
 * @brief Verifica se a lista está cheia, se cheia -> TRUE
...
/**
 * @brief Verifica se a lista está vazia, se vazia -> TRUE
 * @param lista Lista para verificar
...
/**
 * @brief Insere o dado no início da lista (posição 0)
...
/**
 * @brief Insere o dado no fim da lista
 * @param lista Lista para inserir
 * @param valor Valor a ser inserido na lista
 * @return Sucesso na inserção do valor ? True : False
 */
...
/**
 * @brief Insere o dado de maneira ordenada na lista
 * @param lista Lista para inserir
 * @param valor Valor a ser inserido na lista
 * @return Sucesso na inserção do valor ? True : False
 */
...
/**
 * @brief Remove o primeiro elemento da lista, posição 0
...
/**
 * @brief Remove um elemento em específico da lista, se existente
 * @param lista Lista que terá a remoção do elemento
...
/**
 * @brief Verifica se um determinado valor existe na lista
...
/**
 * @brief Verifica se a lista é de tamanho igual ou maior que a posição indicada
 * @param lista Lista para verificação
...
/**
 * @brief Imprime no console a lista
